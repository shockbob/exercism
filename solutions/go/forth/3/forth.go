...
func findCustomWord(word string) (int, bool) {
	if customWords != nil {
...
func defineNewWord(wordIndex int, words []string) (int, error) {
	...
	wordIndex++
	for words[wordIndex] != ";" {
		customIndex, found := findCustomWord(words[wordIndex])
		if found {
	...
	wordIndex++
	customIndex, found := findCustomWord(wordName)
	if found {
...
func interpret(word string, stack []int) ([]int, error) {
	...
	if err == nil {
		...
		customIndex, found := findCustomWord(word)
		if found {
