...
(defn add-language
  ...
  [lang lang-list] (conj lang-list lang)
  )
...
(defn learning-list
  ...
  of languages."
  [] (let [ls (new-list)
           ls (add-language "Cljure" ls)
           ls (add-language "Lisp" ls)
           ls (remove-language ls)
           ls (add-language "Java" ls)
           ls (add-language "JavaScript" ls)]
       (count ls)))
